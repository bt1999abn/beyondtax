...
#     class Meta:
#         model = accounts_models.User
#         fields = ('email', 'password', 'first_name', 'last_name', 'date_of_birth', 'gender', 'phone_number',
...
#     list_display = ('email', 'first_name', 'last_name', 'is_superuser', 'date_of_birth', 'gender', 'phone_number',
#                     'is_active')
...
#         (None, {
#             'classes': ('wide',),
#             'fields': ('email', 'first_name', 'last_name', 'date_of_birth', 'gender', 'phone_number', 'password1',
