...
class IncomeTaxProfile(abstract_models.BaseModel):
    ...
    marital_status = models.IntegerField(choices=MARRIED_STATUS_CHOICES, blank=True, null=True)
    ...
    residential_status = models.IntegerField(choices=RESIDENTIAL_STATUS_CHOICES, blank=True, null=True)
...
class CapitalGains(abstract_models.BaseModel):
    ...
    ownership_percent = models.IntegerField(null=True)
    purchase_date = models.DateField()
    sale_date = models.DateField()
    held_for_no_of_days = models.IntegerField()
    sale_consideration = models.DecimalField(max_digits=30, decimal_places=2,null=True)
    purchase_price = models.DecimalField(max_digits=30, decimal_places=2, null=True)
    transfer_expense = models.DecimalField(max_digits=30, decimal_places=2)
    improvement_expense = models.BooleanField(null=True)
    ...
    property_door_no = models.CharField(max_length=255, null=True)
    property_area = models.CharField(max_length=255, null=True)
    property_city = models.CharField(max_length=255, null=True)
    property_pin = models.CharField(max_length=255, null=True)
    property_state = models.CharField(max_length=255, null=True)
    property_country = models.CharField(max_length=255, null=True)
    term_type = models.IntegerField(choices=TERM_TYPE_CHOICES, null=True)
    stt_paid = models.BooleanField(null=True)
    isn_code = models.CharField(max_length=255, null=True)
    fair_value_per_unit = models.DecimalField(max_digits=30, decimal_places=2, null=True)
    sale_price_per_unit = models.DecimalField(max_digits=30, decimal_places=2, null=True)
    purchase_price_per_unit = models.DecimalField(max_digits=30, decimal_places=2, null=True)
