...
from shared.libs.external.jet.dashboard.dashboard import Dashboard
from shared.libs.external.jet.dashboard.modules import LinkList, RecentActions
from shared.libs.external.jet.dashboard.models import UserDashboardModule
from shared.libs.external.jet.tests.dashboard import TestIndexDashboard
...
class DashboardTestCase(TestCase):
    ...
    def _init_dashboard(self):
        UserDashboardModule.objects.create(
            title='',
            module='shared.libs.external.jet.dashboard.modules.LinkList',
            app_label=None,
        ...
        UserDashboardModule.objects.create(
            title='',
            module='shared.libs.external.jet.dashboard.modules.RecentActions',
            app_label=None,
            user=self.admin_user,
            column=0,
            order=1
